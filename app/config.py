...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="sqlite:///./teckochecker.db",
    ...
    min_poll_interval: int = Field(
        default=30,
        description="Minimum allowed polling interval in seconds"
    )
    max_poll_interval: int = Field(
        default=3600,
        description="Maximum allowed polling interval in seconds"
    )
